...
namespace LoadVantage.Areas.Dispatcher.Services
{
    ...
    {
        public async Task<IEnumerable<LoadViewModel>> GetAllPostedLoadsAsync()
        {
        ...
        public async Task<IEnumerable<LoadViewModel>> GetAllBookedLoadsForDispatcherAsync(Guid dispatcherId)
        {
        ...
        public async Task<IEnumerable<LoadViewModel>> GetAllBilledLoadsForDispatcherAsync(Guid dispatcherId)
        {
