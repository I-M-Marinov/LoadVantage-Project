        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    DispatcherId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Drivers", x => x.DriverId);
                    table.ForeignKey(
                        name: "FK_Drivers_AspNetUsers_DispatcherId",
                        column: x => x.DispatcherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookedLoads", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedLoads_DispatcherId",
                table: "BookedLoads",
                column: "DispatcherId");

            migrationBuilder.CreateIndex(
                name: "IX_BookedLoads_DriverId",
                table: "BookedLoads",
                column: "DriverId");
